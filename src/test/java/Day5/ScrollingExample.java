...
//		driver.findElement(By.xpath("//label[contains(text(),'Testing')]")).click();
		...
		js.executeScript("arguments[0].scrollIntoView(true)", driver.findElement(By.xpath("//label[contains(text(),'hhhh')]")));
		driver.findElement(By.xpath("//label[contains(text(),'hhhh')]//preceding::input[1]")).click();
